...
class Organization(models.Model):
    ...
    lunch_start = models.TimeField(default='13:00', null=True, blank=True)
    lunch_end = models.TimeField(default='14:00', null=True, blank=True)
    has_lunch_break = models.BooleanField(default=True, help_text="Включить обеденный перерыв")
